...
class Enigma(Substitutor):
    ...
    def machine_configuration_process(self, first, first_key, second, second_key, third, third_key, plug_board):
        self.first = first
        self.second = second
        self.third = third
